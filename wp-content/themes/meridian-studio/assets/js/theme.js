...
/**
 * 4.5. Portfolio card click handler
 * Makes a whole `.portfolio-card` clickable if it contains an anchor, and adds keyboard support.
 */
function initPortfolioClicks() {
    ...
    cards.forEach(card => {
        ...
        const link = card.querySelector('a') || card.querySelector('.portfolio-meta a');
        if (link && link.getAttribute('href')) {
            ...
            const go = (e) => {
                // Let native anchors handle Ctrl/Cmd clicks
