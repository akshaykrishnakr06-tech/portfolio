 ...
 */
return array(
	'title'      => esc_html__( 'Post Two Column', 'fse-portfolio' ),
	'categories' => array( 'fse-portfolio', 'Post Two Column' ),
...
<!-- wp:post-title {"isLink":true,"style":{"typography":{"fontSize":"22px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"fse-portfolio-inter"} /-->

<!-- wp:post-excerpt {"excerptLength":20,"style":{"elements":{"link":{"color":{"text":"#747474"}}},"color":{"text":"#747474"},"typography":{"fontSize":"16px"}},"fontFamily":"fse-portfolio-inter"} /-->
