 ...
 */
return array(
	'title'      => esc_html__( 'Archive Inner Banner', 'fse-portfolio' ),
	'categories' => array( 'fse-portfolio', 'Archive Inner Banner' ),
